using MyRepository = GestorMaestro.Administration.Repositories.UserPermissionRepository;
using MyRow = GestorMaestro.Administration.UserPermissionRow;

namespace GestorMaestro.Administration.Endpoints;
